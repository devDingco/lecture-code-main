...
import BoardsWriteAdvanced from "@/components/10-01-boards-write-advanced-hooks-typescript-codegen";
...
export default function BoardComponentEditPage() {
  ...
  const { data } = useQuery<FetchBoardQuery, FetchBoardQueryVariables>(
    FetchBoardDocument,
    {
      variables: {
  ...
  return (
    ...
    <>
      <div>
        이 텍스트는 페이지 컴포넌트의 것 입니다. 서로 다른 컴포넌트들을 조립할
        때 사용함
      </div>
      <div>
        이 텍스트는 페이지 컴포넌트의 것 입니다. 서로 다른 컴포넌트들을 조립할
